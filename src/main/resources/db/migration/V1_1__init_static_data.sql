...
-- 서브 퀘스트
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (10001,'TIME_MINUTE','MOOD_LOG','기상 후 {0:d}분 동안 스마트폰 잠금 모드 유지하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (10009,'TIME_MINUTE','MOOD_LOG','디지털 사용 중단 후 {0:d}분간 다른 활동 해보기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (10010,'TIME_MINUTE','MOOD_LOG','디지털 사용 중단 후 {0:d}분간 산책하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20001,'TIME_MINUTE','MOOD_LOG','기상 후 {0:d}분 내로 스트레칭 시작하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20005,'TIME_MINUTE','MOOD_LOG','기상 후 {0:d}분 동안 스마트폰 미사용하고 스트레칭 하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20008,'NUMBER_3','MOOD_LOG','하루 {0:d}회 이상 의식적으로 물 1컵 마시기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20011,'TIME_MINUTE','MOOD_LOG','잠자기 전 {0:d}분 동안 수면 유도 명상하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20014,'TIME_MINUTE','MOOD_LOG','잠들기 전 {0:d}분간 디지털 기기 사용 중단 유지하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20015,'ONCE','MOOD_LOG','오늘 섭취한 가공식품 개수 기록하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20016,'NUMBER_3','MOOD_LOG','앱을 활용해 하루 걸음 수 {0:d}회 이상 기록하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20019,'TIME_MINUTE','MOOD_LOG','작업 중 {0:d}분마다 눈 깜빡이기 의식적으로 하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20020,'ONCE','MOOD_LOG','집중 작업 전 모니터 밝기와 색온도 조정하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20021,'NUMBER_3','MOOD_LOG','하루 {0:d}회 이상 먼 곳 바라보며 눈 근육 풀기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20022,'TIME_MINUTE','MOOD_LOG','잠자기 전 {0:d}분간 눈 감고 휴식하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20023,'TIME_HOUR','MOOD_LOG','오늘 하루 동안 {0:d}시간 이상 앉아 있었는지 기록하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20024,'ONCE','MOOD_LOG','앉아있는 자세에서 어깨 회전 스트레칭 수행하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20025,'TIME_MINUTE','MOOD_LOG','생각날 때 허리 펴고 바른 자세로 {0:d}분 유지하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20026,'ONCE','MOOD_LOG','스트레칭 진행 전후로 컨디션 점검하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (20027,'NUMBER_3','MOOD_LOG','하루 중 {0:d}회 이상 스스로 자세 점검하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (30007,'NUMBER_3','MOOD_LOG','상대방의 말에 열린 질문 {0:d}회 던지기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40001,'NUMBER_1','MOOD_LOG','오늘 배운 내용을 {0:d}문장으로 정리하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40002,'NUMBER_3','MOOD_LOG','중요 개념을 {0:d}회 반복해서 말해보기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40003,'ONCE','MOOD_LOG','배운 내용을 친구에게 한 번 설명해보기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40004,'NUMBER_1','MOOD_LOG','새로 배운 개념을 관련 분야 {0:d}개 찾기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40005,'NUMBER_1','MOOD_LOG','관련 주제의 기사 {0:d}개 읽기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40008,'NUMBER_1','MOOD_LOG','학습 내용에서 핵심 키워드 {0:d}개 뽑기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40009,'NUMBER_1','MOOD_LOG','수업 중 들었던 질문 {0:d}개 메모하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40010,'NUMBER_1','MOOD_LOG','강의나 글에서 인상적인 문장 {0:d}개 적어보기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40011,'NUMBER_3','MOOD_LOG','배운 내용을 하루 생활 속에서 {0:d}회 적용하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40012,'ONCE','MOOD_LOG','실천 후 느낀 점을 간단히 기록하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40013,'NUMBER_1','MOOD_LOG','하루 학습 내용을 {0:d}문장으로 요약하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40014,'NUMBER_1','MOOD_LOG','오늘 배운 단어 {0:d}개로 짧은 문장 만들기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40015,'NUMBER_2','MOOD_LOG','핵심 문장을 {0:d}초 동안 끊김 없이 말하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40016,'NUMBER_3','MOOD_LOG','복습 카드를 {0:d}회 만들어 보기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40017,'NUMBER_1','MOOD_LOG','관련 사례 {0:d}개 찾고 메모하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (40018,'NUMBER_1','MOOD_LOG','배운 내용 도식 {0:d}개 업데이트하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50001,'NUMBER_1','MOOD_LOG','처음 가는 동네의 주요 명소 {0:d}곳 방문하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50002,'NUMBER_1','MOOD_LOG','방문한 동네에서 인상적인 장면 {0:d}장 촬영하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50003,'NUMBER_1','MOOD_LOG','방문한 동네의 현지 음식 {0:d}가지 맛보기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50004,'TIME_MINUTE','MOOD_LOG','처음 배우는 악기의 기본 연습 {0:d}분 진행하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50005,'NUMBER_1','MOOD_LOG','새 악기로 간단한 곡 {0:d}곡 연주 도전하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50006,'NUMBER_1','MOOD_LOG','악기 연습 과정 중 새로 배운 점 {0:d}개 기록하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50007,'NUMBER_3','MOOD_LOG','새로운 운동 동작 {0:d}회 반복 연습하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50008,'TIME_MINUTE','MOOD_LOG','배운 운동 기술을 {0:d}분간 실습하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50009,'NUMBER_1','MOOD_LOG','운동 후 느낀 변화를 {0:d}문장으로 작성하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50010,'ONCE','MOOD_LOG','새로운 요리를 한 입 시식하고 첫인상 기록하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50011,'NUMBER_1','MOOD_LOG','먹은 요리의 재료 {0:d}가지 알아보기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50012,'NUMBER_1','MOOD_LOG','요리에서 인상적인 맛 요소 {0:d}개 메모하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50013,'NUMBER_3','MOOD_LOG','처음 보는 사람에게 인사 {0:d}회 건네기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50014,'NUMBER_1','MOOD_LOG','인사 후 상대 반응 {0:d}가지 기록하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50015,'NUMBER_1','MOOD_LOG','대화 시작을 위한 첫 마디 {0:d}가지 준비하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50016,'NUMBER_1','MOOD_LOG','출근/등교 경로에서 새로운 풍경 {0:d}장 촬영하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50017,'TIME_MINUTE','MOOD_LOG','평소보다 다른 길을 걸은 시간 {0:d}분 기록하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (50018,'NUMBER_1','MOOD_LOG','새 경로에서 발견한 특징 {0:d}가지 메모하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60001,'ONCE','MOOD_LOG','기상 후 바로 침대 정리하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60002,'NUMBER_1','MOOD_LOG','아침 물 {0:d}컵 마시기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60003,'TIME_MINUTE','MOOD_LOG','아침 햇빛 받으며 {0:d}분 산책하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60004,'TIME_MINUTE','MOOD_LOG','아침 스트레칭 {0:d}분 하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60005,'NUMBER_1','MOOD_LOG','아침 식사에 단백질 음식 {0:d}개 포함하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60006,'ONCE','MOOD_LOG','아침 식사 시간 기록하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60007,'TIME_MINUTE','MOOD_LOG','아침 명상 {0:d}분 하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60008,'NUMBER_1','MOOD_LOG','아침 계획 노트에 오늘 할 일 {0:d}개 적기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60009,'NUMBER_1','MOOD_LOG','아침에 뉴스 기사 {0:d}개 읽고 요약하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60010,'NUMBER_1','MOOD_LOG','아침 운동 전 물 {0:d}컵 마시기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60011,'DISTANCE','MOOD_LOG','아침 러닝 {0:d}km 하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60012,'NUMBER_1','MOOD_LOG','아침 근력 운동 {0:d}세트 하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60013,'NUMBER_1','MOOD_LOG','아침에 어제 감사했던 일 {0:d}개 쓰기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (60017,'TIME_MINUTE','MOOD_LOG','아침 준비 시간 {0:d}분 측정하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70002,'TIME_MINUTE','MOOD_LOG','취침 시간 {0:d}분 전에 조명 어둡게 하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70003,'ONCE','MOOD_LOG','기상 후 바로 창문 열어 햇빛 받기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70004,'TIME_MINUTE','MOOD_LOG','취침 전 {0:d}분 동안 휴대폰 사용하지 않기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70005,'ONCE','MOOD_LOG','침실에 휴대폰 두지 않기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70006,'NUMBER_1','MOOD_LOG','취침 전 디지털 기기 사용을 {0:d}회 줄이기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70007,'TIME_MINUTE','MOOD_LOG','취침 전 {0:d}분간 전신 스트레칭');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70008,'NUMBER_1','MOOD_LOG','목, 어깨 스트레칭 {0:d}회 하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70009,'NUMBER_1','MOOD_LOG','취침 전 요가 자세 {0:d}개 수행하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70010,'NUMBER_1','MOOD_LOG','기상 시간 맞추기 알람 {0:d}개 설정');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70011,'TIME_MINUTE','MOOD_LOG','아침 기상 후 {0:d}분 내에 일어나기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70012,'ONCE','MOOD_LOG','아침 기상 시 침대 정리하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70013,'NUMBER_1','MOOD_LOG','취침 전 독서 {0:d}쪽 읽기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70016,'TIME_MINUTE','MOOD_LOG','침실 바닥 청소 {0:d}분 하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70017,'ONCE','MOOD_LOG','침대 시트 교체하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (70018,'NUMBER_1','MOOD_LOG','방 안 환기 {0:d}회 하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (80001,'ONCE','MOOD_LOG','최근 일주일간 소비 내역 정리하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (80002,'NUMBER_1','MOOD_LOG','소비 내역 중 불필요 지출 {0:d}개 뽑아보기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (80012,'NUMBER_1','MOOD_LOG','구매 목록 중 불필요 항목 {0:d}개 삭제하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (80017,'NUMBER_1','MOOD_LOG','구매 욕구 참은 이유 {0:d}개 기록하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (80018,'ONCE','MOOD_LOG','하루 소비 내역 점검하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (80019,'NUMBER_1','MOOD_LOG','즉흥 구매 유혹을 받은 상황 {0:d}개 기록하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (80028,'NUMBER_1','MOOD_LOG','저축 동기 {0:d}개 적어보기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90001,'NUMBER_1','MOOD_LOG','감정 어휘 {0:d}개 수집하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90002,'NUMBER_1','MOOD_LOG','오늘 대화에서 새 감정 어휘 {0:d}개 사용하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90003,'NUMBER_3','MOOD_LOG','기분이 변한 순간 {0:d}회 메모하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90004,'ONCE','MOOD_LOG','느낀 감정을 1문장으로 즉시 말해보기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90005,'NUMBER_1','MOOD_LOG','특정 감정을 담은 문장 {0:d}개 작성하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90006,'NUMBER_1','MOOD_LOG','장면 감정 묘사 {0:d}문장 필사하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90007,'NUMBER_1','MOOD_LOG','목소리 톤 {0:d}단계 변화 연습하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90008,'NUMBER_3','MOOD_LOG','같은 문장을 억양 다르게 {0:d}회 읽기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90009,'NUMBER_3','MOOD_LOG','거울 보며 표정 {0:d}회 연습하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90010,'NUMBER_1','MOOD_LOG','제스처 {0:d}개 선택해 말에 적용하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90011,'ONCE','MOOD_LOG','친구에게 감사 인사 전하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90012,'NUMBER_1','MOOD_LOG','감정 일기 {0:d}문장 쓰기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90013,'NUMBER_1','MOOD_LOG','오늘 감정을 색 {0:d}개로 표시하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90014,'NUMBER_1','MOOD_LOG','대화 녹음 후 감정 표현 피드백 {0:d}개 적기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90015,'NUMBER_1','MOOD_LOG','다른 사람 말투 {0:d}개 따라 해보기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90016,'NUMBER_1','MOOD_LOG','감정 표현 시 금지어 {0:d}개 정하고 피하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90017,'NUMBER_3','MOOD_LOG','표현 전 심호흡 {0:d}회 하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (90018,'NUMBER_3','MOOD_LOG','대화에서 공감 표현 {0:d}회 시도하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (100001,'NUMBER_1','MOOD_LOG','중심 주제 후보 {0:d}개 적기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (100002,'NUMBER_1','MOOD_LOG','1차 가지 {0:d}개 뻗기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (100003,'ONCE','MOOD_LOG','유사 항목 통합하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (100004,'TIME_MINUTE','MOOD_LOG','타이머 {0:d}분 설정해 브레인 덤프 하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (100009,'NUMBER_1','MOOD_LOG','반론 {0:d}개 상상하고 반박 포인트 적기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (100010,'NUMBER_1','MOOD_LOG','하루 핵심 장면 {0:d}개 선정하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (100011,'NUMBER_1','MOOD_LOG','오늘 배운 것 {0:d}개 적기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (100012,'TIME_MINUTE','MOOD_LOG','{0:d}분동안 오늘 일기 쓰기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (100017,'NUMBER_2','MOOD_LOG','핵심 메시지 {0:d}초 요약 말하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (100018,'NUMBER_1','MOOD_LOG','핵심 포인트 {0:d}개 정리하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110001,'NUMBER_1','MOOD_LOG','주요 주장 {0:d}개와 각 근거 작성하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110002,'NUMBER_3','MOOD_LOG','기사의 주장·근거 구조 분석하기 {0:d}회');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110003,'ONCE','MOOD_LOG','논문에서 핵심 주장과 지원 근거 표시하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110004,'NUMBER_1','MOOD_LOG','사건의 원인 {0:d}개와 그에 따른 결과 정리하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110005,'NUMBER_1','MOOD_LOG','역사 사건의 원인·결과 연결 {0:d}개 정리하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110006,'NUMBER_1','MOOD_LOG','뉴스에서 원인과 결과 추론 {0:d}개 작성하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110007,'NUMBER_1','MOOD_LOG','상대 주장 읽고 반박 근거 {0:d}개 작성하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110008,'NUMBER_1','MOOD_LOG','토론에서 반대 입장 자료 {0:d}개 수집하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110009,'NUMBER_3','MOOD_LOG','반박문 초안 검토 {0:d}회 수행하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110010,'NUMBER_1','MOOD_LOG','가능한 해결책 {0:d}개 적기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (110011,'NUMBER_1','MOOD_LOG','해결책별 장점 {0:d}개씩 나열하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120001,'NUMBER_1','MOOD_LOG','스포츠 기본 동작 {0:d}개 익히기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120002,'NUMBER_3','MOOD_LOG','유튜브로 가이드 영상 시청 {0:d}회');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120003,'NUMBER_3','MOOD_LOG','기초 기술 실습 {0:d}회');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120006,'NUMBER_3','MOOD_LOG','스트레칭 {0:d}회 수행');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120007,'NUMBER_1','MOOD_LOG','근력 운동 동작 {0:d}개 수행');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120008,'NUMBER_3','MOOD_LOG','유산소 운동 {0:d}회 진행');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120012,'NUMBER_3','MOOD_LOG','팀 연습 경기 {0:d}회 참여');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120013,'NUMBER_3','MOOD_LOG','모임원과 기술 교류 {0:d}회');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120014,'NUMBER_3','MOOD_LOG','경기 전후 인사 나누기 {0:d}회');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120015,'ONCE','MOOD_LOG','모임 소감 기록하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120016,'NUMBER_3','MOOD_LOG','관심 있는 종목 경기 {0:d}회 시청');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120017,'NUMBER_1','MOOD_LOG','응원팀 후보 {0:d}개 목록 만들기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120018,'NUMBER_3','MOOD_LOG','팀 정보 조사 {0:d}회 진행');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120021,'NUMBER_3','MOOD_LOG','경기 규칙서 {0:d}회 읽기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120022,'NUMBER_3','MOOD_LOG','전략 분석 영상 {0:d}회 시청');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120023,'NUMBER_1','MOOD_LOG','규칙 요약 {0:d}개 작성');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120026,'NUMBER_1','MOOD_LOG','운동 시간표 {0:d}개 작성');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120027,'NUMBER_3','MOOD_LOG','루틴 점검 {0:d}회 수행');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (120028,'NUMBER_1','MOOD_LOG','루틴 보완 아이디어 {0:d}개 작성');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130001,'NUMBER_2','MOOD_LOG','읽고 싶은 책 {0:d}권 선정');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130002,'NUMBER_3','MOOD_LOG','독서 세션 {0:d}회 진행');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130003,'NUMBER_1','MOOD_LOG','작품·콘텐츠 리뷰 {0:d}개 읽기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130004,'NUMBER_1','MOOD_LOG','음악 새 장르 {0:d}개 탐색');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130005,'NUMBER_3','MOOD_LOG','추천 플레이리스트 청취 {0:d}회');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130006,'NUMBER_1','MOOD_LOG','좋아요/저장 트랙 {0:d}개 선정');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130007,'NUMBER_1','MOOD_LOG','관심 작품 {0:d}개 큐에 추가');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130008,'NUMBER_3','MOOD_LOG','트레일러/클립 시청 {0:d}회');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130009,'NUMBER_3','MOOD_LOG','시청 세션 {0:d}회 진행');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130010,'NUMBER_1','MOOD_LOG','감상 노트 {0:d}개 작성');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130011,'NUMBER_1','MOOD_LOG','운동 체험 후보 {0:d}개 정리');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130012,'TIME_MINUTE','MOOD_LOG','체험 장소/클래스 탐색 {0:d}분');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130013,'NUMBER_3','MOOD_LOG','운동 체험 세션 {0:d}회');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130014,'NUMBER_1','MOOD_LOG','준비물 {0:d}개 구비');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130015,'NUMBER_1','MOOD_LOG','게임 체험할 장르 {0:d}개 고르기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130016,'NUMBER_3','MOOD_LOG','데모/체험판 설치 {0:d}회');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130019,'NUMBER_1','MOOD_LOG','작품 아이디어 {0:d}개 메모');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130020,'NUMBER_1','MOOD_LOG','재료 {0:d}개 준비');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130021,'NUMBER_3','MOOD_LOG','기초 기법 연습 {0:d}회');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130022,'TIME_MINUTE','MOOD_LOG','작업 시간 {0:d}분 확보');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130023,'ONCE','MOOD_LOG','완성 사진 공유하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (130024,'NUMBER_1','MOOD_LOG','플랫폼/커뮤니티 팔로우 {0:d}개');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (140001,'NUMBER_1','MOOD_LOG','목적지 후보 {0:d}곳의 장단점 비교하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (140005,'NUMBER_1','MOOD_LOG','목적지 대표 음식 {0:d}가지 조사하기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (150009,'NUMBER_1','PHOTO_LOG','대표 한식 반찬 {0:d}종 만들기');
...
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (150019,'NUMBER_1','PHOTO_LOG','대표 한식 국물 요리 {0:d}종 끓여보기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (150020,'NUMBER_3','MOOD_LOG','아침 식사 {0:d}일분 식단 구성안 작성하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (150021,'TIME_MINUTE','PHOTO_LOG','출근 전 {0:d}분 완성하는 아침 메뉴 연습하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (150022,'ONCE','MOOD_LOG','자취방 환경에 맞는 조리도구 구성하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (150023,'NUMBER_3','PHOTO_LOG','{0:d}일 연속 자취 요리 사진 공유하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (150024,'NUMBER_1','MOOD_LOG','디저트 {0:d}종 선정 후 재료 준비하기');
INSERT INTO sub_quest (id,action_unit_type, confirm_type, name) VALUES (150025,'NUMBER_1','PHOTO_LOG','디저트 {0:d}종 데코레이션 연습하기');
